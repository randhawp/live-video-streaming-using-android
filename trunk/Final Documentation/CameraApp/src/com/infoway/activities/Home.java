...
import com.infoway.camapp.CameraClass;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        btnStart.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				Intent home=new Intent(getApplicationContext(), CameraClass.class);
				startActivity(home);
			}
		}); 
    ...
    private void createResources()
    {
    	if(!checkResources())
    	{
    		try
    		{
    			...
    			copyResources(R.raw.background, fileRoot+"/background.jpg");
    			File imagesDir = new File(fileRoot+"/images");
    			imagesDir.mkdir();
    		}
    		catch(Exception e)
    		{
